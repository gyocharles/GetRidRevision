package userInt;
/**
 * This class will handle the posting of books and removal of them
 */
...
public class RidFrame extends JFrame {
	...
	private void createButtons()
	{
		...
		/**
		 * When pressed, this button will take information from the various textfields and enter it into the database
		 */
		ActionListener PostBookListener = new ActionListener() 
		{
			...
			{
				int sellerAccnum;
				String isbn, title, authorFirstname, authorLastname, condition, sellerName;
				double price;
				...
				//Return to main menu after posting book
				dispose();
